...
export const receptors: Receptor[] = [
  ...
  { id: 'r10', name: 'MAO-A', type: 'Enzima Alvo', neurotransmitterSystem: 'Aminas', description: 'Cataboliza serotonina e noradrenalina; a MAO-A intestinal degrada a tiramina da dieta — por isso sua inibição (IMAOs) provoca a crise hipertensiva do queijo.' },
  { id: 'r11', name: 'MAO-B', type: 'Enzima Alvo', neurotransmitterSystem: 'Aminas', description: 'Metaboliza preferencialmente feniletilamina e contribui para o catabolismo da dopamina no SNC; alvo da selegilina (IMAO-B) no Parkinson.' },
  ...
  { id: 'r15', name: 'VGCC-α2δ', type: 'Canal Iônico', neurotransmitterSystem: 'Glutamatérgico / Cálcio', description: 'Canal de cálcio dependente de voltagem, subunidade \u03B12\u03B4.' },
  ...
  { id: 'r20', name: 'xCT', type: 'Transportador', neurotransmitterSystem: 'Glutamatérgico', description: 'Antiporter cistina-glutamato (sistema xc−); regula o glutamato extrassináptico e é alvo indireto da N-acetilcisteína.' },
...
export const enzymes: MetabolicEnzyme[] = [
  ...
  { id: 'e3', name: 'CYP1A2', description: 'Metaboliza cafeína, clozapina, olanzapina e duloxetina. É induzida pela fumaça do tabaco (hidrocarbonetos), por isso fumantes costumam precisar de doses maiores de clozapina.', location: 'Hepático' },
  { id: 'e4', name: 'CYP2C19', description: 'Metaboliza escitalopram/citalopram, diazepam, clopidogrel e inibidores de bomba de prótons. Tem forte polimorfismo genético (metabolizadores lentos e ultrarrápidos).', location: 'Hepático' },
...
export const pdInteractions: MoleculeReceptorInteraction[] = [
  ...
  // Alternatives/Outros
  { moleculeId: 'm31', receptorId: 'r4', actionType: 'Inibidor de Recaptação', affinityKi: 1400 },
