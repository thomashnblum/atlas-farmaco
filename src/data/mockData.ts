...
const baseMolecules: Molecule[] = [
  ...
  // ISRSN
  { id: 'm9', name: 'Venlafaxina', tradeNames: ['Effexor', 'Efexor XR'], class: 'ISRSN', clinicalAxes: ['Antidepressivo', 'Ansiolitico'], mechanisms: 'Inibe SERT em baixas doses; adição de inibição NET em doses mais altas.', notes: 'Pode induzir elevação sustentada da pressão arterial (dose-dependente).' , halfLife: "5h (O-desmetilvenlafaxina: 11h)", bioavailability: "45%", onsetOfAction: "2-4 semanas", peakPlasma: "2h (IR); 5.5h (XR)", proteinBinding: "27-30%", elimination: "Renal (87%)", therapeuticDoseRange: "75-375 mg/dia" },
